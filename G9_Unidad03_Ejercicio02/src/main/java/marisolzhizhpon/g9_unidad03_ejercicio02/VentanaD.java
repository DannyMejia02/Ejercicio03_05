...
public class VentanaD extends JFrame {
    ...
    public void iniciarBotones(){
        ...
        this.jPanelList.get(12).add(this.jButtonList.get(0));
        this.jPanelList.get(12).add(this.jButtonList.get(1));    
    }
    ...
    public void iniciarChecks(){
        ...
        this.jCheckboxList.add(new JCheckBox("Nuevos"));
         ...
         this.jPanelList.get(10).add(this.jCheckboxList.get(0));
    ...
    public void iniciarCombo(){
        ...
        this.jPanelList.get(8).add(this.jComboBox1);
        ...
        this.jPanelList.get(9).add(this.jComboBox2);
        
        this.jComboBox3 = new JComboBox();
        this.jComboBox3.addItem("No");
        this.jComboBox3.addItem("Si");
        
        this.jPanelList.get(11).add(this.jComboBox3);
